    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b ${isScrolled ? "bg-white/95 border-gray-100 py-4 md:py-6" : "bg-transparent border-white/20 py-6 md:py-8"}`}>
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="hidden md:block">
          <button className={`px-6 py-2 rounded-xl font-bold text-sm tracking-widest transition-all ${isScrolled ? "border-2 border-brand-dark text-brand-dark hover:bg-brand-dark hover:text-white" : "border-2 border-white text-white hover:bg-white hover:text-brand-dark"}`}>
            Anfragen
          </button>
        </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col p-4 gap-4">
              ...
              <button className="btn-primary w-full text-center">Jetzt anfragen</button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
...
const Hero = () => {
  return (
    <section className="relative overflow-hidden">
      <AuroraHeroComponent>
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 md:gap-16 items-center py-24 md:py-48">
          <motion.div
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              <button className="w-full sm:w-auto bg-white text-brand-dark px-8 py-4 rounded-2xl font-bold text-lg shadow-xl transition-transform hover:scale-105 active:scale-95 leading-none">
                Kostenlos anfragen
              </button>
    ...
    <section id="about" className="py-20 md:py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        <div className="relative order-2 md:order-1">
          <div className="rounded-[3rem] md:rounded-[4rem] overflow-hidden shadow-2xl relative z-10 border-4 md:border-[12px] border-white">
            <img 
              src="/src/assets/images/regenerated_image_1778668190607.png" 
              alt="Professional cleaning service" 
              className="w-full aspect-[4/5] object-cover"
            />
          </div>
          <div className="absolute -top-10 -right-10 w-48 h-48 md:w-64 md:h-64 bg-brand-mint/10 rounded-full -z-0 blur-3xl" />
          
          <div className="absolute -bottom-6 -right-2 md:bottom-10 md:right-10 z-20 bg-brand-dark text-white p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-2xl max-w-[160px] md:max-w-xs">
            <p className="text-xl md:text-3xl font-display font-extrabold mb-1">5+ Jahre</p>
            <p className="text-[10px] opacity-70 uppercase tracking-widest font-bold">Erfahrung im Service</p>
          </div>
        </div>

        <div className="space-y-6 md:space-y-8 order-1 md:order-2">
          <div className="badge">Ganz persönlich</div>
          ...
          <div className="mt-12">
            <button className="btn-primary">Lernen Sie uns kennen</button>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-5xl mx-auto relative overflow-hidden bg-brand-dark rounded-[3rem] p-12 md:p-20 text-center text-white shadow-2xl">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <button className="btn-primary w-full sm:w-auto">Kostenlos Anfragen</button>
